                    ...
                    <li>
                        ...
                        <div class="list-btn">
                            ...
                            <a href="<?php echo $music_link."?play=1"?>" class="play-icon" data-music="<?php echo $musicID;?>" target="_blank">
                                <svg class="list-btn-icon icon-play" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 232.153 232.153" style="enable-background:new 0 0 232.153 232.153;" xml:space="preserve">
                                    <g>
                            ...
                            <?php if($facebook){?>
                                <abbr title="facebook">
                                    <a target="_blank" href="<?php echo $facebook?>">
                                        <svg class="social-media-icon icon-facebook" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 96.124 96.123" style="enable-background:new 0 0 96.124 96.123;" xml:space="preserve"><g><g>
                            ...
                            <?php if($instagram){?>
                                <abbr title="instagram">
                                    <a class="social-media-icons instagram" target="_blank" href="<?php echo $instagram?>">
                                        <svg class="social-media-icon icon-instagram" xmlns="http://www.w3.org/2000/svg" id="instagram_Layer_1" viewBox="0 0 551.034 551.034" x="0px" y="0px" xmlns:xml="http://www.w3.org/XML/1998/namespace" xml:space="preserve" version="1.1">
                                            <g>
                            ...
                            <?php if($youtube){?>
                                <abbr title="youtube">
                                    <a class="social-media-icons youtube" target="_blank" href="<?php echo $youtube?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="social-media-icon icon-youtube" viewBox="0 -77 512.002 512" width="512px" height="512px">
                                            <g>
                            ...
                            <?php if($spotify){?>
                                <abbr title="spotify">
                                    <a class="social-media-icons spotify" target="_blank" href="<?php echo $spotify?>">
                                        <svg class="social-media-icon icon-spotify" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <g>
                            ...
                            <?php if($website){?>
                                <abbr title="website">
                                    <a class="social-media-icons website" target="_blank" href="<?php echo $website?>">
                                        <svg class="social-media-icon icon-website" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 15 15" style="enable-background:new 0 0 15 15;" xml:space="preserve">
                                            <g>
                            ...
                            <?php if($twitter){?>
                                <abbr title="twitter">
                                    <a class="social-media-icons twitter" target="_blank" href="<?php echo $twitter?>">
                                        <svg class="social-media-icon icon-twitter" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 612 612" style="enable-background:new 0 0 612 612;" xml:space="preserve"><g><g>
                                            <g>
    ...
    <div class="social-media">
        ...
        <div class="wrapper">
            ...
            <?php if($instagram){?>
                <abbr title="instagram">
                    <a class="social-media-icons instagram" target="_blank" href="<?php echo $instagram?>">
                        <svg class="social-media-icon icon-instagram" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="img" viewBox="0 0 448 512"><path  d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                    </a>
                </abbr>
            <?php    
            }?>
            ...
            <?php if($soundcloud){?>
                <abbr title="soundcloud">
                    <a class="social-media-icons soundcloud" target="_blank" href="<?php echo $soundcloud?>">
                        <svg class="social-media-icon icon-soundcloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="soundcloud_Layer_1" x="0px" y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve"><g><g id="XMLID_526_">
